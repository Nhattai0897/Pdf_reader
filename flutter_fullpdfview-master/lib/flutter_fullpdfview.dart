    ...
    switch (call.method) {
      case 'onRender':
        if (_widget.onRender != null) {
          _widget.onRender!(int.parse(call.arguments['pages'].toString()));
        }

        return null;
      case 'onPageChanged':
        if (_widget.onPageChanged != null) {
          _widget.onPageChanged!(int.parse(call.arguments['page'].toString()),
              int.parse(call.arguments['total'].toString()));
        }
      ...
      case 'onPageError':
        if (_widget.onPageError != null) {
          _widget.onPageError!(int.parse(call.arguments['page'].toString()),
      ...
      case 'onZoomChanged':
        if (_widget.onZoomChanged != null) {
          _widget
              .onZoomChanged!(double.parse(call.arguments['zoom'].toString()));
        }
        return null;
    }
